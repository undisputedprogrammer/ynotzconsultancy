<div class=" lg:relative lg:h-[830px] xl:h-[890px] 2xl:h-[950px]">
    ...
    <div class="w-[88%] lg:w-[450px] xl:w-[563px] 2xl:w-[675px] centered-x mx-auto bg-white rounded-xl mt-3 lg:mt-[135px] xl:mt-[180px] 2xl:mt-[240px] shadow-md pt-5 lg:absolute">
        ...
        <form class="w-[82%] mt-8 mx-auto" action="">
            ...
            <input class=" rounded-xl w-full border border-gray-200 font-satoshiregular pl-5 lg:py-[16px] mt-3" type="text" placeholder="Name" required>
            <input class=" rounded-xl w-full border border-gray-200 font-satoshiregular pl-5 lg:py-[16px] mt-3" type="text" placeholder="Company name" required>
            <div class="relative mt-3">
                ...
                <input type="tel" class=" border border-gray-200 rounded-xl font-satoshiregular text-[16px] h-[44px] block w-full pl-24 lg:py-[16px] lg:h-[57px]" placeholder="Phone">
              </div>
              <input class="btn-blue rounded-xl text-white font-satoshimedium w-full py-2 mt-3 lg:mt-8 mb-12 lg:py-[13px] lg:text-lg" type="submit" name="submit" value="Send">
        </form>
    </div>
    </div>
...
<div class=" lg:flex lg:w-[75%] lg:mx-auto lg:justify-between  ">
