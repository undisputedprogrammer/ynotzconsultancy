<div class=" bg-gray my-10 py-4 lg:flex">
@php
...
<div class=" mx-5 flex space-x-4 lg:space-x-4 overflow-auto hide-scroll lg:justify-center mt-7 mb-7 lg:order-first lg:flex-wrap lg:w-[60%]">
    @php
        $t=true;
        $f=false;
        $src="icons/code.svg";
