<div class="mt-[60px] lg:mt-[90px] lg:flex justify-center lg:items-center lg:mb-24">
<img class="w-[90%] lg:w-[540px] rounded-xl mx-auto lg:mx-8" src="{{asset('images/home/Enquire.png')}}" alt="">
<div class=" w-[89%] lg:w-[550px]  mx-auto lg:mx-8 mt-[50px] lg:mt-0 bg-gray-lg rounded-xl lg:py-[90px] lg:px-[30px]">
